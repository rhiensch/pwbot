...
namespace BotTests
{
	...
	public class InvadeAdviserTests
	{
		...
		public void TestInvadeNeutralPlanet()
		{
			...
			Assert.AreEqual(21 + 100 + 5*3 + 1, moves[0].NumSheeps + moves[1].NumSheeps);
		}
		...
		public void TestInvadeCorrectNumber()
		{
			PlanetWars planetWars = new PlanetWars(
				...
				"P 16.773642 19.093699 1 22 1#18\n" +
